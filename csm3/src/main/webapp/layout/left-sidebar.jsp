                ...
                <div class="left-sidebar-content">
                    <ul class="sidebar-elements">
                      ...
                      phẩm</span></a>
                        ...
                        <li class="parent"><a><i class="icon mdi mdi-shopping-cart"></i><span>Quản lý đơn
                      hàng</span></a>
                            <ul class="sub-menu">
                                <li><a><span>Danh sách đơn hàng</span></a>
                                </li>
                                <li class="parent"><a><span>Duyệt đơn hàng</span></a>
                                    <ul class="sub-menu">
